...
public class ActsMapSingle {
	
	
	UrlIP ip = new UrlIP();
	private String GetJsonStr(String ns ,String uid){
		
		String jsonstr = null;
		String url = ip.GetUtilIP()+ "CityTreasureHunterServlet/servlet/ActsMapSingleServlet";
	...
	public String[][] GetActsList(String ns,String uid){
		String json = null;
		
		String[][] rest = null;
	
		
		json = GetJsonStr(ns,uid);
	...
	public double[][] ChangeToDoubleSingle(String ns,String uid){
		String[][] rest = this.GetActsList(ns,uid);
