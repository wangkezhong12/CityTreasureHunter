...
public class GetSid {
	UrlIP ip = new UrlIP();
	public String Getsid(String slat ,String slon, String type){
		String url = ip.GetUtilIP()+ "CityTreasureHunterServlet/servlet/GetActIDServlet";
		...
		params.add(new BasicNameValuePair("slat",slat));
		params.add(new BasicNameValuePair("slon",slon));
