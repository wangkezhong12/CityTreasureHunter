...
public class ActsMapTeam {
	
	
	UrlIP ip = new UrlIP();
	private String GetJsonStr(String ns ,String tid){
		
		String jsonstr = null;
		String url = ip.GetUtilIP()+ "CityTreasureHunterServlet/servlet/ActsMapTeamServlet";
	...
	public String[][] GetActsList(String ns,String tid){
		String json = null;
		
		String[][] rest = null;
	
		
		json = GetJsonStr(ns,tid);
	...
	public double[][] ChangeToDoubleTeam(String ns,String tid){
		String[][] rest = this.GetActsList(ns,tid);
