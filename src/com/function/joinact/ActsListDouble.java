...
public class ActsListDouble {
	UrlIP ip = new UrlIP();
	private String GetJsonStr(String ns ,String limitrows,String offsetrows){
		
		String jsonstr = null;
		String url =  ip.GetUtilIP()+ "CityTreasureHunterServlet/servlet/ActsListDoubleServlet";
	...
	public String[][] GetDoubleActList(String type,String limitrows,String offsetrows){
		String json = null;
		...
		json = GetJsonStr(ns,limitrows,offsetrows);
		JSONArray jsonArray;
		try {
