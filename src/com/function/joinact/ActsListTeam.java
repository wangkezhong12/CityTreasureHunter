...
public class ActsListTeam {
	UrlIP ip = new UrlIP();
	private String GetJsonStr(String ns ,String tid,String limitrows,String offsetrows){
		
		String jsonstr = null;
		String url =  ip.GetUtilIP()+ "CityTreasureHunterServlet/servlet/ActsListTeamServlet";
	...
	public String[][] GetTeamActList(String type,String tid,String limitrows,String offsetrows){
		String json = null;
		...
		json = GetJsonStr(ns,tid,limitrows,offsetrows);
		JSONArray jsonArray;
		try {
