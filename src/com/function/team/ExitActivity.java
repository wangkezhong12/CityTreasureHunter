...
public class ExitActivity extends AsyncTask{
	...
	protected Object  doInBackground(Object... params_obj){
		...
		CharSequence ishead="";
		String result="";
		teamid=params_obj[0].toString();
		usersid=params_obj[1].toString();
		ishead=params_obj[2].toString();
		try{
			//Toast.makeText(a, "3", Toast.LENGTH_SHORT).show();
			HttpPost httpRequest =new HttpPost(HttpUtil.EXITACTIVITY_URL);
			//请求数据
