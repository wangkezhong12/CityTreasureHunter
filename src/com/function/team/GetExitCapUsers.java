...
public class GetExitCapUsers {

	public String doInBackground(String tid,String sign)
	{
		String json="";
		CharSequence teamid="";
		CharSequence signs="";
		...
		try{
			...
			HttpPost httpRequest =new HttpPost(HttpUtil.GETEXITORCAP_URL);
			//请求数据
			...
			params.add(new BasicNameValuePair("signs",signs.toString()));
			//对提交数据进行编码，设置编码方式
			...
			if(httpResponse.getStatusLine().getStatusCode()==200){
				try {
					...
					// 获取对象对应的值      
					rest= item.getString("exitorcapnames");   
