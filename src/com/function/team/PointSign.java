...
public class PointSign extends AsyncTask{
	...
	protected Object doInBackground(Object... params_obj)
	{
		...
		tid=params_obj[0].toString();
		uid=params_obj[1].toString();
		correct=params_obj[2].toString();
		
		try{
			HttpPost httpRequest =new HttpPost(HttpUtil.POINTSIGN_URL);
			if(!tid.equals("")&&!uid.equals("")&&!correct.equals("")){
				...
				params.add(new BasicNameValuePair("corr",correct.toString()));
	...
	protected void onPostExecute(Object result) {
		//MainActivity.show_login.setText(result.toString());
		//FindpswdActivity.progressDialogfind.cancel();
	}	
}
